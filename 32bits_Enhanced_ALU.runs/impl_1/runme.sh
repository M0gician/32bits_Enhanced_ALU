...
HD_PWD='D:/Xilinx/32btis_Enhanced_ALU/32bits_Enhanced_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_32Bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_32Bits.tcl -notrace
