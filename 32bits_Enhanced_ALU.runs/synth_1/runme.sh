...
HD_PWD='D:/Xilinx/32btis_Enhanced_ALU/32bits_Enhanced_ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_32Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_32Bits.tcl
